...
public class InterpolationController extends FunctionalityController implements Initializable
{
    ...
    public void saveAll()
    {
        ...
        try
        {
            ValueManager.register(Tag.tags.get(tag.getText()), Double.valueOf(TEXT_FIELD_1.getText()), Double.valueOf(TEXT_FIELD_2.getText()), Double.valueOf(TEXT_FIELD_3.getText()), CHECK_BOX_1.isSelected(), CHECK_BOX_2.isSelected());
        } catch (Exception e)
        {
            return;
        }
